...
class OrderCompletedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject('Pesanan Selesai! #' . $this->order->order_number . ' | Rasaconnect')
        ...
        return $mail->action('Lihat Detail Pesanan', $url)
                    ->line('Kami sangat menghargai kepercayaan Anda berbelanja bersama Rasaconnect. Sampai jumpa di pesanan berikutnya!')
