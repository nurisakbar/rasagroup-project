        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="{{ route('driippreneur.stock.sync') }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Sync semua produk dengan stock 0?');">
                            @csrf
                ...
                <div class="box-body" style="border-bottom: 1px solid #f4f4f4;">
                    <form action="{{ route('driippreneur.stock.index') }}" method="GET" class="form-inline">
                        ...
                        @if(request('search') || request('filter'))
                            <a href="{{ route('driippreneur.stock.index') }}" class="btn btn-default">
                                ...
                                <div class="modal fade" id="updateStockModal{{ $stock->id }}" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <form action="{{ route('driippreneur.stock.update', $stock) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-header bg-purple">
                                                    <button type="button" class="close" data-dismiss="modal" style="color: #fff;">&times;</button>
                                                    <h4 class="modal-title" style="color: #fff;">Update Stock</h4>
                                                </div>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center">
                                        <p class="text-muted" style="padding: 40px 0;">
                                            ...
                                            @else
                                                Belum ada produk di hub Anda.<br>
