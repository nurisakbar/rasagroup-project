                ...
                <div class="card border-0 shadow-sm p-40 border-radius-30" style="background-color: #ffffff;">
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <a href="{{ route('distributor.orders.show', $order) }}" class="btn btn-outline-rasa" style="min-width: 200px;">
                                <i class="fi-rs-file-text mr-10"></i>Detail Pesanan
                            </a>
                            <a href="{{ route('distributor.orders.products') }}" class="btn" style="min-width: 200px;">
