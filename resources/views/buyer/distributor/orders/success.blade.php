                ...
                <div class="card border-0 shadow-sm p-40 border-radius-30" style="background-color: #ffffff;">
                    <div class="card-body text-center">
                        @if($order->payment_status === 'pending')
                            <div class="mb-30">
                                <i class="fi-rs-document-signature" style="font-size: 80px; color: #ea580c;"></i>
                            </div>
                            <h2 class="mb-20 checkout-page-title" style="font-weight: 700; color: #253D4E;">Menunggu Pembayaran</h2>
                            <p class="text-dark mb-40">Pesanan Anda telah tercatat. Silakan <strong>selesaikan pembayaran</strong> di bawah ini agar pesanan Anda dapat segera kami proses.</p>
                        @else
                            <div class="mb-30">
            ...
            .va-number {
                ...
                letter-spacing: 0.5px !important;
                        ...
                        @endif
                            ...
                            @endif
                            <a href="{{ route('distributor.orders.show', $order) }}" class="btn text-white shadow-sm px-4 py-3" style="background-color: #6A1B1B; border-radius: 12px; min-width: 220px; font-weight: 600; border: none; letter-spacing: 0.5px;">
                                <i class="fi-rs-file-text mr-5"></i> Detail Pesanan
                            </a>
                            <a href="{{ route('distributor.orders.products') }}" class="btn text-white shadow-sm px-4 py-3" style="background-color: #6A1B1B; border-radius: 12px; min-width: 220px; font-weight: 600; border: none; letter-spacing: 0.5px;">
...
<div class="modal fade" id="changePaymentModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="border-radius: 20px;">
      ...
      <form action="{{ route('distributor.orders.change-payment', $order) }}" method="POST">
        @csrf
