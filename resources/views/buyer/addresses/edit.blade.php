                                    ...
                                    <form action="{{ route('buyer.addresses.update', $address) }}" method="POST" id="addressForm">
                                            ...
                                            <div class="form-group col-md-12 mb-4">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 mb-3 mt-2 label-selector">
                                                    @foreach(['Rumah' => 'home', 'Kantor' => 'briefcase', 'Toko' => 'shop', 'Lainnya' => 'marker'] as $label => $icon)
                                                        ...
                                                        <label class="btn btn-outline-brand rounded-pill px-4 py-2" for="label-{{ $icon }}"><i class="fi-rs-{{ $icon }} mr-5"></i> {{ $label }}</label>
                                                    @endforeach
                                                </div>
                                            </div>
                                        ...
                                        <div class="location-box border-radius-15 bg-white p-4 p-md-5 mt-20 mb-30 border shadow-sm">
                                            <div class="row align-items-start">
                                                ...
                                                <div class="form-group col-md-4 mb-20 village-group" id="village_container" style="{{ $address->village_id ? '' : 'display: none;' }}">
                                                ...
                                                <div class="form-group col-md-12 mb-4">
                                                    ...
                                                    <textarea required class="form-control custom-textarea @error('address_detail') is-invalid @enderror" 
                                                              ...
                                                              tabindex="1"
                                                              placeholder="Contoh: Jl. Diponegoro No. 123, Blok C2, RT. 001/002, Kel. Menteng">{{ old('address_detail', $address->address_detail) }}</textarea>
                                                </div>
                                                ...
                                                <div class="form-group col-md-12 mb-0">
                                                    ...
                                                    <input type="text" class="form-control custom-input @error('notes') is-invalid @enderror" 
                                                           name="notes" value="{{ old('notes', $address->notes) }}" 
                                        ...
                                        <div class="d-grid mt-40 pt-20 border-top">
                                            <button type="submit" class="btn btn-fill-out btn-lg w-100 rounded-pill font-weight-bold" id="btnSubmit">
                                                <i class="fi-rs-check-circle mr-10"></i> <span id="btnText">Simpan Perubahan Alamat</span>
