        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-geo-alt-fill"></i> Tambah Alamat Pengiriman</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row mb-3">
                            <div class="col-md-9">
                                ...
                                <textarea class="form-control @error('address_detail') is-invalid @enderror" 
                                          ...
                                          placeholder="Nama jalan, nomor rumah, RT/RW, patokan, dll" required>{{ old('address_detail') }}</textarea>
