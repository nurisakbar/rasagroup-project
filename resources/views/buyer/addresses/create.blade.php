                ...
                <div class="card border-0 shadow-sm border-radius-20 overflow-hidden" style="background-color: #ffffff;">
                    <div class="card-header bg-white border-bottom p-30">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ ($redirectToCheckout ?? false) ? (session('checkout_return_origin') === 'distributor_checkout' ? route('distributor.orders.checkout') : route('checkout.index')) : route('buyer.addresses.index') }}" class="btn btn-sm btn-outline-rasa rounded-pill">
                            ...
                            <div class="mb-40">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" required class="form-control custom-input" name="address_detail" value="{{ old('address_detail') }}" placeholder="Nama Jalan, No. Rumah, RT/RW">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control custom-input" id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="Latitude" readonly style="background-color: #e9ecef !important;">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control custom-input" id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="Longitude" readonly style="background-color: #e9ecef !important;">
                                            </div>
                                        </div>
