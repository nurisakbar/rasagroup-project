                    ...
                    <div class="dashboard-menu shadow-sm border-radius-15 p-4 bg-white">
                        ...
                        <ul class="nav flex-column" role="tablist">
                            ...
                            <li class="nav-item mt-20">
                                <form method="POST" action="{{ route('logout') }}" id="logout-form-index-address">
                                    @csrf
                                    <a class="nav-link text-danger" href="#" onclick="event.preventDefault(); document.getElementById('logout-form-index-address').submit();">
