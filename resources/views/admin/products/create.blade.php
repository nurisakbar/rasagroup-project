                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group @error('code') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code') }}" placeholder="SKU">
                                    @error('code')
                            ...
                            <div class="col-md-3">
                                <div class="form-group @error('unit') has-error @enderror">
                                    ...
                                    <select class="form-control" id="unit" name="unit">
                                        ...
                                        <option value="PK" {{ old('unit') === 'PK' ? 'selected' : '' }}>Pack (PK)</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group @error('weight') has-error @enderror">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="weight" name="weight" value="{{ old('weight', 500) }}" step="1" min="1" required>
