                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group @error('commercial_name') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control input-lg" id="commercial_name" name="commercial_name" value="{{ old('commercial_name') }}" placeholder="Contoh: Coconut Milk" required style="font-weight: bold;">
