                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group @error('price') has-error @enderror">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="price_display" value="{{ number_format(old('price', (int)$product->price), 0, ',', '.') }}" placeholder="0" required style="font-size: 1.1em; font-weight: bold; color: #6A1B1B;">
                                        <input type="hidden" id="price" name="price" value="{{ old('price', (int)$product->price) }}">
                                    </div>
                                    @error('price')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group @error('reseller_point') has-error @enderror">
                                    <label for="reseller_point"><i class="fa fa-star"></i> Kominisi Affiliator</label>
                                    <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group @error('is_discount') has-error @enderror">
                                    ...
                                    <select class="form-control" id="is_discount" name="is_discount">
                                        <option value="0" {{ old('is_discount', $product->is_discount) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('is_discount', $product->is_discount) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    @error('is_discount')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3 discount-fields" style="display: none;">
                                <div class="form-group @error('discount_price') has-error @enderror">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="text" class="form-control" id="discount_price_display" value="{{ old('discount_price', $product->discount_price) ? number_format(old('discount_price', $product->discount_price), 0, ',', '.') : '' }}" placeholder="0" style="font-size: 1.1em; font-weight: bold; color: #E74C3C;">
                                        <input type="hidden" id="discount_price" name="discount_price" value="{{ old('discount_price', (int)$product->discount_price) }}">
                                    </div>
                            ...
                            <div class="col-md-3 discount-fields" style="display: none;">
                                <div class="form-group @error('discount_start_date') has-error @enderror">
                                    ...
                                    <input type="date" class="form-control" id="discount_start_date" name="discount_start_date" value="{{ old('discount_start_date', $product->discount_start_date ? \Carbon\Carbon::parse($product->discount_start_date)->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-3 discount-fields" style="display: none;">
                                <div class="form-group @error('discount_end_date') has-error @enderror">
                                    ...
                                    <input type="date" class="form-control" id="discount_end_date" name="discount_end_date" value="{{ old('discount_end_date', $product->discount_end_date ? \Carbon\Carbon::parse($product->discount_end_date)->format('Y-m-d') : '') }}">
