...
<style>
    ...
    #driippreneurs-table_length { margin-bottom: 15px; }
</style>
@endpush
...
$(document).ready(function() {
    var table = $('#driippreneurs-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('admin.driippreneurs.index') }}",
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'status_badge', name: 'driippreneur_status', orderable: false },
            { data: 'applied_at_formatted', name: 'driippreneur_applied_at' },
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (typeof toastr !== 'undefined') {
                    toastr.success(response.success || 'Aplikasi berhasil disetujui.');
                } else {
                    alert(response.success || 'Aplikasi berhasil disetujui.');
                }
            },
            error: function(xhr) {
    ...
    $(document).on('click', '.reject-btn', function() {
        ...
        window.location.href = '{{ url("admin/driippreneurs") }}/' + userId;
    });
});
</script>
@endpush
