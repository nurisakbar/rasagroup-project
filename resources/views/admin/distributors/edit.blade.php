                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @error('aturan_minimal_masa_berlaku') has-error @enderror">
                                    ...
                                    <input type="number" class="form-control" id="aturan_minimal_masa_berlaku" name="aturan_minimal_masa_berlaku" value="{{ old('aturan_minimal_masa_berlaku', $distributor->aturan_minimal_masa_berlaku) }}" placeholder="Contoh: 6">
