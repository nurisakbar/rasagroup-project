                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('monthly_target') has-error @enderror">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="monthly_target" name="monthly_target" value="{{ old('monthly_target', $distributor->monthly_target) }}" placeholder="Contoh: 50000000">
                                    </div>
