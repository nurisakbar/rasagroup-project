                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('monthly_target') has-error @enderror">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rupiah-format" id="monthly_target" name="monthly_target" value="{{ number_format(old('monthly_target', $distributor->monthly_target ?? 0), 0, ',', '.') }}" placeholder="Contoh: 50.000.000">
                                    </div>
