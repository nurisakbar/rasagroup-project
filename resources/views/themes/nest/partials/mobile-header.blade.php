        ...
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-top">
                <div class="mobile-header-logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('logo/Rasa Connect - Logo 2_Maroon 1.png') }}" alt="logo" style="width: 120px !important; min-width: 120px !important; height: auto !important; object-fit: contain;" />
                    </a>
                </div>
