            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href="/"><img src="{{ asset('logo/Rasa Connect - Logo 2_Maroon 1.png') }}" alt="logo" style="width: 120px !important; min-width: 120px !important; height: auto !important; object-fit: contain;" /></a>
                    </div>
                                ...
                                <div class="d-flex categori-dropdown-inner">
                                    @php
                                        ...
                                        foreach ($leftOrder as $name) {
                                            $cat = $allCategories->first(function($c) use ($name) {
                                                return strtolower($c->slug) === strtolower($name) || strtolower($c->name) === strtolower($name);
                                            });
                                            if ($cat) {
                                                $cat->display_name = strtoupper($name);
                                                $col1->push($cat);
                                            }
                                        }
