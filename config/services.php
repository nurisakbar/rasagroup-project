...
return [
    ...
    */
    ...
    'faspay' => [
        ...
        'private_key_dev_path' => env('FASPAY_SNAP_PRIVATE_KEY_DEV_PATH', 'storage/app/faspay_private_key_dev.pem'),
        'private_key_prod_path' => env('FASPAY_SNAP_PRIVATE_KEY_PROD_PATH', 'storage/app/faspay_private_key.pem'),
